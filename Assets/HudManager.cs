...
public class HudManager : MonoBehaviour {
    ...
    private void Update()
    {
        ...
        if (player1HitBoxCollider.comboCounter > 1)
        {
            ...
            ComboDamageCounterPlayer1.text = "Damage " + player1HitBoxCollider.comboCounterPercentage + " %";
        ...
        if (player2HitBoxCollider.comboCounter > 1)
        {
            ...
            ComboDamageCounterPlayer2.text = "Damage " + player2HitBoxCollider.comboCounterPercentage + " %";
        }
    }
}
